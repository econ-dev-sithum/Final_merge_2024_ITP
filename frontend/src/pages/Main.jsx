  ...
  return (
    <div className="flex flex-col justify-between items-center min-h-screen py-10">
      <div className="flex justify-between space-x-4 mt-64">
        ...
        <button onClick={() => navigate('/transportHome')} className="px-4 py-2 bg-blue-500 text-white rounded">Employee</button>
        <button onClick={() => navigate('/transportHome')} className="px-4 py-2 bg-blue-500 text-white rounded">Food</button>
        <button onClick={() => navigate('/transportHome')} className="px-4 py-2 bg-blue-500 text-white rounded">Inventory</button>
        ...
        <button onClick={() => navigate('/transportHome')} className="px-4 py-2 bg-blue-500 text-white rounded">Reservation</button>
      </div>
    </div>
  );
}
