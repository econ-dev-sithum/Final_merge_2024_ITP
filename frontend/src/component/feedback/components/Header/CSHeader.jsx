      ...
      <div className="flex h-[70px] flex-row justify-between bg-black w-[100%] mt-3 pb-3">
        ...
        <div className="flex flex-row h-[70px] justify-between">
          <div className='flex flex-col h-[66px] text-white justify-between font-BreeSerif' >
            <div className=''>Class & Schedule Manager</div>
      ...
      <div className='flex h-[50px] flex-row justify-between bg-PMnavbar w-[100%] mt-3 pb-3 shadow-md font-BreeSerif my-10'>
        <div className='flex flex-row h-[66px] justify-between mt-1 mb-2 ml-12'>
          <Link to="/csfitness/home" >
            <button className='h-10 bg-PMnavbar hover:bg-gray-500 w-40 text-ternary rounded-xl text-center'>ClassHome</button>
          </Link>
          <Link to="/csfitness/shome" >
            <button className='h-10 bg-PMnavbar hover:bg-gray-500 w-40 text-ternary rounded-xl text-center'>ScheduleHome</button>
          </Link>
          <Link to="/csfitnesss/create" >
            <button className='h-10 bg-PMnavbar hover:bg-gray-500 w-60 text-ternary rounded-xl'>Add Schedule</button>
          </Link>
          <Link to="/RawcsRequests" >
            <button className='h-10 bg-PMnavbar hover:bg-gray-500 w-60 text-ternary rounded-xl'>View Results</button>
          </Link>
        </div>
      </div>
    </div>
