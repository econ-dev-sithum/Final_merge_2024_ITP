...
const FBHeader = () => {
  return (
    <div>
      <div className="flex h-[70px] flex-row justify-between bg-black-200 w-[100%] mt-3 pb-3">
        <div>
        ...
        <div className="flex flex-row h-[70px] justify-between">
          <div className='flex flex-col h-[66px] text-white justify-between font-BreeSerif' >
            <div className=''>Customer Service Manager</div>
      ...
      <div className='flex h-[50px] flex-row justify-between bg-PMnavbar w-[100%] mt-3 pb-3 shadow-md font-BreeSerif my-10'>
        <div className='flex flex-row h-[66px] justify-between mt-1 mb-2 ml-12'>
          ...
          <Link to="/fbfitnesss/create" >
            <button className='h-10 bg-PMnavbar hover:bg-gray-500 w-60 text-ternary rounded-xl'>Ticket Raise</button>
          </Link>
          <Link to="/RawfbRequests" >
            <button className='h-10 bg-PMnavbar hover:bg-gray-500 w-60 text-ternary rounded-xl'>View Ticket</button>
          </Link>
          <Link to="/Home/Feedback" >
            <button className='h-10 bg-PMnavbar hover:bg-gray-500 w-60 text-ternary rounded-xl'>User view</button>
          </Link>
        </div>
      </div>
    </div>
