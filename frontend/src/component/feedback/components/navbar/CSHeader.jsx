      ...
      <div className="flex h-[70px] flex-row justify-between bg-black w-[100%] mt-3 pb-3">
        ...
        <div className="flex flex-row h-[70px] justify-between">
          <div className='flex flex-col h-[66px] text-white justify-between font-BreeSerif' >
            <div className=''>Class manager</div>
            <button className=" h-10 border-2 bg-gray-700 w-20 text-white rounded-xl ml-8">Login</button>
          </div>
      ...
      <div className='flex h-[50px] flex-row justify-between bg-PMnavbar w-[100%] mt-3 pb-3 shadow-md font-BreeSerif my-10'>
        <div className='flex flex-row h-[66px] justify-between mt-1 mb-2 ml-12'>
          ...
          <Link to="/csfitness/shome" >
            <button className='h-10 bg-PMnavbar hover:bg-gray-500 w-60 text-ternary rounded-xl'>Excercises</button>
          </Link>
          <Link to="/csfitnesss/create" >
            <button className='h-[40px] bg-PMnavbar hover:bg-gray-500 w-40 text-ternary rounded-xl'>Add Schedule Form</button>
          </Link>
          <Link to="/csFitness/userdetails/:id" >
            <button className='h-[40px] bg-PMnavbar hover:bg-gray-500 w-60 text-ternary rounded-xl'>Schedule List</button>
          </Link>
        </div>
      </div>
    </div>
