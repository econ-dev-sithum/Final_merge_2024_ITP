      ...
      <div className="flex h-[70px] flex-row justify-between bg-black w-[100%] mt-3 pb-3">
        ...
        <div className="flex flex-row h-[70px] justify-between">
          <div className='flex flex-col h-[66px] text-white justify-between font-BreeSerif' >
            <div className=''>Inventory Manager</div>
      ...
      <div className='flex h-[50px] flex-row justify-between bg-PMnavbar w-[100%] mt-3 pb-3 shadow-md font-BreeSerif my-10'>
        <div className='flex flex-row h-[66px] justify-between mt-1 mb-2 ml-12'>
          ...
          <Link to="/rmRequests/create" >
            <button className='h-10 bg-PMnavbar hover:bg-gray-500 w-60 text-ternary rounded-xl'>Class & Schedule</button>
          </Link>
          <Link to="/RawmRequests" >
            <button className='h-[40px] bg-PMnavbar hover:bg-gray-500 w-40 text-ternary rounded-xl'>Inventory</button>
          </Link>
          <Link to="/RawsuRequests" >
            <button className='h-[40px] bg-PMnavbar hover:bg-gray-500 w-60 text-ternary rounded-xl'>Medical Support</button>
          </Link>
          <Link to="#" >
            <button className='h-[40px] bg-PMnavbar hover:bg-gray-500 w-60 text-ternary rounded-xl'>Personal Traning</button>
          </Link>
        </div>
      </div>
    </div>
