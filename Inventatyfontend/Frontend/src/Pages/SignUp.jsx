...
export default function SignUp() {
    ...
    return (
        <div className="min-h-screen " style={{
            backgroundImage: `url('https://hotelfurnitureconcept.com/wp-content/uploads/2021/02/hotel-reception-desk-made-in-Turkey-0-1-16.12.32.jpg')`,
            ...
            <div className="flex p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-20">
                ...
                <Link to ="/" className="text-5xl font-bold dark:text-white font-tangerine">
                    <span className="px-2 py-1 bg-gradient-to-r from-indigo-500 via purple-500 to-pink-500  text-white rounded-lg  size-10/12" >Inventory</span>Shop
                </Link>
